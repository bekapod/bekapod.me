    ...
    return (
      <html {...this.props.htmlAttributes} lang="en">
        <head>
          ...
          })(window,document,'script','dataLayer','GTM-WXK2BZD');`}}></script>
        </head>
        <body {...this.props.bodyAttributes}>
          <noscript dangerouslySetInnerHTML={{ __html: `<iframe src='https://www.googletagmanager.com/ns.html?id=GTM-WXK2BZD'
